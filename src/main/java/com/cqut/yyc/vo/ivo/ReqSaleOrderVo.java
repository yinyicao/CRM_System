...
public class ReqSaleOrderVo extends RequestMessageBase {
	private int saleId;
	...
	public ReqSaleOrderVo(int saleId, String saleNo, String proName, String cusNo, double proPrice, int proNum,
	...
	public String toString() {
		return "ReqSaleOrderVo [saleId=" + saleId + ", saleNo=" + saleNo + ", proName=" + proName + ", cusNo=" + cusNo
				+ ", proPrice=" + proPrice + ", proNum=" + proNum + ", proTotal=" + proTotal + ", proDate=" + proDate
				+ ", proState=" + proState + "]";
	}
	public ReqSaleOrderVo() {
